...
export default function FixedRoutesManagement() {
  ...
  const vehicles = [
    { id: 'standard', name: 'Standard Sedan' },
    { id: 'executive', name: 'Executive Sedan' },
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        {routes.length === 0 ? (
          <div className="text-center py-12 text-gray-500">
            ...
            <p>No fixed routes configured yet</p>
            <p className="text-sm mt-1">Click &quot;New Route&quot; to add your first fixed route</p>
          </div>
        ) : (
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {routes.map((route) => (
                  <tr key={route.routeId}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{route.vehicleName}</td>
